...
class Lookup(QWidget):
    ...
    def _setupUi(self):
        ...
        self._shortcutUp = QShortcut(seq, self.searchEdit, None, None, Qt.WidgetShortcut)
        seq = QKeySequence(Qt.Key_Down)
        self._shortcutDown = QShortcut(seq, self.searchEdit, None, None, Qt.WidgetShortcut)
